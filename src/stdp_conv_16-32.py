...
np.savez_compressed(open('stdp_conv_features_2-layer_1.npz','wb'), features_X=features_X1)
np.savez_compressed(open('stdp_conv_features_2-layer_2.npz','wb'), features_X=features_X2)
np.savez_compressed(open('stdp_conv_features_2-layer_w.npz','wb'), syn_L1_W=syn_L1_W, syn_L2_W=syn_L2_W, syn_L1_W_raw=syn_L1_W_raw, syn_L2_W_raw=syn_L2_W_raw)

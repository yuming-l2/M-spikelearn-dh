...
LOG_PATH='/local/data/yuming/stdp_mnist_deephyper'
CHPT_PATH='/local/data/yuming/stdp_mnist_deephyper/checkpoints'
DH_LOG_PATH='/local/data/yuming/stdp_mnist_deephyper/dh_log_dir'

...
class SpikingNet:
    ...
    def get_synapse(self, pos_name, *pre_names):
        synapses=[]
        for syn_ind in self.layer_synapses[pos_name]:
            if self.pre_synapse[syn_ind]==list(pre_names):
                synapses.append(self.synapses[syn_ind])

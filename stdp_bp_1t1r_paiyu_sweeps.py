...
G1list=[1e-5, 2e-5, 5e-5, 1e-4, 2e-4, 7e-6, 1.4e-5, 7e-5, 5e-4, 1e-3, 2e-3]
...
def work(G1, pot_vbase, dep_vbase):
    ret=os.system(f'srun -p fast-long -c 1 -u python3 src/bp_stdp.py 1T1R_T {G1} {pot_vbase} {dep_vbase}')
